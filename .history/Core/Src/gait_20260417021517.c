...
#define jump_freq1 0.018f   // 0.01
#define jump_freq2 0.15f   // 0.40 跳
#define jump_freq3 0.017f   // 0.07
#define jump_freq4 0.015f   // 0.01
...
// 每个电机的发力表现不同
 ...
 float motor7_kp_offset = 0.27f;
 float motor8_kp_offset = 0.40f;
...
{
    float height_des = 38.0f; // 蹬地腿长
    float jump_step_height = height_des - 13.0f; // 抬腿高度,参考点为轴心

    float forward_prep_step = 10.0f; // 起跳前水平准备距离
	...
	quick_set_kp(2.7f); // 跳跃时增大Kp，提升响应速度
