...
float support_Kp = 0.10f; // 0.6/0.7,0.25/0.3
float swing_Kp = 0.1f;
...
void motion_Crawl(float step_height, float stride){
    ...
    if (tau <= 0.5f)
    {
        ...
        hposition1.B_y  = FrontState.ySwing;
        hposition1.B_x  =  FrontState.xSwing; 
        hposition2.B_y  = BackState.ySupport;
        hposition2.B_x  =  BackState.xSupport; 
        hposition3.B_y  = BackState.ySwing;
        hposition3.B_x  =  BackState.xSwing; 
        hposition4.B_y  = FrontState.ySupport;
    ...
    else if (tau > 0.5f && tau <= 1.0f)
    {
        ...
        hposition1.B_y  = FrontState.ySupport;
        hposition1.B_x  =  FrontState.xSupport; 
        hposition2.B_y  = BackState.ySwing;
        hposition2.B_x  =  BackState.xSwing;
        hposition3.B_y  = BackState.ySupport;
        hposition3.B_x  =  BackState.xSupport;
        hposition4.B_y  = FrontState.ySwing;
